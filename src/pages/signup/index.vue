    ...
    <view class="content">
        ...
        <view class="form">
            <view class="inputWrapper">
                <input class="input" type="text" v-model="username" placeholder="输入用户名(至少3个字符)"/>
            </view>
            <view class="inputWrapper">
                <input class="input" type="password" v-model="password" placeholder="输入密码(至少5个字符)"/>
            </view>
			<view class="roleWrapper">
				<radio-group @change="roleChange">
					<label class="radio radiocus"><radio value="1" />司机</label>
					<label class="radio radiocus"><radio value="0" checked="true"/>乘客</label>
				</radio-group>
			</view>
